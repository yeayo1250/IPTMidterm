    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                <h2 class="text-uppercase mb-0">CheapTalk Developer</h2>
                <!-- Masthead Avatar Image-->
                <img class="masthead-avatar mb-5" src="assets/img/kyle.jpg" alt="..." />
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">CHRISTIAN KIEHL CAMBANGAY</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">STUDENT OF MDC</p>
            </div>
        </header>
